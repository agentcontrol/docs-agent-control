...
See the [Reference Guide](/reference) for complete control configuration documentation.
...
- [Customer Support Agent](/examples/customer-support) - Full example with multiple tools
- [LangChain SQL Agent](/examples/langchain-sql) - SQL injection protection
- [Galileo Luna-2 Integration](/examples/galileo-luna2) - AI-powered toxicity detection

## Documentation

- [Reference Guide](/reference) - Complete API and configuration reference
- [Examples Overview](/examples/overview) - Working code examples and patterns
- [Architecture](https://github.com/agentcontrol/agent-control/blob/sdks/python/ARCHITECTURE.md) - SDK architecture and design patterns
