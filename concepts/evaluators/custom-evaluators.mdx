...
These evaluators can then be published as wheels and installed in your agent control server.
If you want to contribute evaluator to AgentControl repo, see [Contributing Evaluator](/concepts/evaluators/contributing-evaluator). 
...
Refer [DeepEval Example](/exampes/deepeval) for creating Custom Evaluators.