...
| `DATABASE_URL` | — | Legacy alias for `AGENT_CONTROL_DB_URL` |
| `DB_URL` | — | Legacy alias for `AGENT_CONTROL_DB_URL` |
| `DB_HOST` | `localhost` | Legacy alias for `AGENT_CONTROL_DB_HOST` |
| `DB_PORT` | `5432` | Legacy alias for `AGENT_CONTROL_DB_PORT` |
| `DB_USER` | `agent_control` | Legacy alias for `AGENT_CONTROL_DB_USER` |
| `DB_PASSWORD` | `agent_control` | Legacy alias for `AGENT_CONTROL_DB_PASSWORD` |
| `DB_DATABASE` | `agent_control` | Legacy alias for `AGENT_CONTROL_DB_DATABASE` |
| `DB_DRIVER` | `psycopg` | Legacy alias for `AGENT_CONTROL_DB_DRIVER` |
