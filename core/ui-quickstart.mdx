...
> **Note:** If you started the server using **Option A — SDK Only** from the [Quickstart](/core/quickstart#option-a-sdk-only-fastest), the UI is already running at [http://localhost:4000](http://localhost:4000). You can skip the setup steps below and jump directly to [viewing the dashboard](#create-controls-from-the-ui).
