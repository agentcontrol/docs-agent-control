...
Then jump to [Step 3: Register Your Agent](#step-3-register-your-agent).
...
For details on what is happening under the hood and next steps, refer to the complete [Quickstart](/core/quickstart#what-is-happening-under-the-hood) guide.
