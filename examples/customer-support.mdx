...
description: Full example with multiple tools, PII protection, and prompt injection defense.
---
...
Controls are defined on the server via the UI, not in code.
...
[`Customer Support Agent Example`](https://github.com/agentcontrol/agent-control/tree/main/examples/customer_support_agent)
