...
The  contains [Agent Control Examples](https://github.com/agentcontrol/agent-control/tree/main/examples) directory contains examples demonstrating how to use Agent Control in various scenarios.
...
- [Server Documentation](/components/server)
- [Models Documentation](/components/models)
...
<CardGroup cols={2}>
  ...
  <Card title="Galileo Luna-2" icon="wand-magic-sparkles" href="https://github.com/agentcontrol/agent-control/tree/main/examples/galileo/">
