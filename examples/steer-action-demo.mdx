...
| File | Description |
|:-----|:------------|
| [setup_controls.py](setup_controls.py) | Creates the demo controls |
| [autonomous_agent_demo.py](autonomous_agent_demo.py) | Interactive banking agent |
| [interactive_demo.py](interactive_demo.py) | CLI demo with manual steps |
