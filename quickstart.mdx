...
> **Prefer a full demo walkthrough?** See the complete example in `examples/agent-control-demo.mdx` for an end-to-end, runnable alternative.
...
## Step 2: Create Demo Controls + Policy (server-side)
